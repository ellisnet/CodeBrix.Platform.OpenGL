    ...
    public static T RotateLeft<T>(T value, int offset) where T : unmanaged
    {
        ...
        static T Byte(T value, int offset)
        {
            if (typeof(T) == typeof(byte))
            {
                ...
                return (T) (object) (byte) ((v << offset) | (v >> (8 - offset)));
            }
        ...
        static T SByte(T value, int offset)
        {
            if (typeof(T) == typeof(sbyte))
            {
                ...
                return (T) (object) (sbyte) ((v << offset) | (v >> (8 - offset)));
            }
        ...
        static T UShort(T value, int offset)
        {
            if (typeof(T) == typeof(ushort))
            {
                ...
                return (T) (object) (ushort) ((v << offset) | (v >> (16 - offset)));
            }
        ...
        static T Short(T value, int offset)
        {
            if (typeof(T) == typeof(short))
            {
                ...
                return (T) (object) (short) ((v << offset) | (v >> (16 - offset)));
            }
