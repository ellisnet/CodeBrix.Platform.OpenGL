...
public unsafe partial struct ID3DDestructionNotifier : IComVtbl<ID3DDestructionNotifier>, IComVtbl<CodeBrix.Platform.OpenGL.Core.Native.IUnknown>
{
    ...
    public static implicit operator CodeBrix.Platform.OpenGL.Core.Native.IUnknown(ID3DDestructionNotifier val)
        => Unsafe.As<ID3DDestructionNotifier, CodeBrix.Platform.OpenGL.Core.Native.IUnknown>(ref val);
