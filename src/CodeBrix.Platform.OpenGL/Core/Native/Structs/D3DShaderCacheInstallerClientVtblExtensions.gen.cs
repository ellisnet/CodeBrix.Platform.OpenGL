...
public unsafe static class D3DShaderCacheInstallerClientVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetInstallerName(this ComPtr<ID3DShaderCacheInstallerClient> thisVtbl, nuint* pNameLength, [UnmanagedType(CodeBrix.Platform.OpenGL.Core.Native.UnmanagedType.LPUTF8Str)] string pName)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetInstallerName(this ComPtr<ID3DShaderCacheInstallerClient> thisVtbl, ref nuint pNameLength, [UnmanagedType(CodeBrix.Platform.OpenGL.Core.Native.UnmanagedType.LPUTF8Str)] string pName)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (nuint* pNameLengthPtr = &pNameLength)
    ...
    /// <summary>To be documented.</summary>
    public static int GetInstallerName(this ComPtr<ID3DShaderCacheInstallerClient> thisVtbl, Span<nuint> pNameLength, [UnmanagedType(CodeBrix.Platform.OpenGL.Core.Native.UnmanagedType.LPUTF8Str)] string pName)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        return @this->GetInstallerName(ref pNameLength.GetPinnableReference(), pName);
