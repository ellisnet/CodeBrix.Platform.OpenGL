...
public unsafe partial struct ID3D10Blob : IComVtbl<ID3D10Blob>, IComVtbl<CodeBrix.Platform.OpenGL.Core.Native.IUnknown>
{
    ...
    public static implicit operator CodeBrix.Platform.OpenGL.Core.Native.IUnknown(ID3D10Blob val)
        => Unsafe.As<ID3D10Blob, CodeBrix.Platform.OpenGL.Core.Native.IUnknown>(ref val);
