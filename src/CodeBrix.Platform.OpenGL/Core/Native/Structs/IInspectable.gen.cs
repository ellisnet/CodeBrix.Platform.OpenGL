...
public unsafe partial struct IInspectable : IComVtbl<IInspectable>, IComVtbl<CodeBrix.Platform.OpenGL.Core.Native.IUnknown>
{
    ...
    public static implicit operator CodeBrix.Platform.OpenGL.Core.Native.IUnknown(IInspectable val)
        => Unsafe.As<IInspectable, CodeBrix.Platform.OpenGL.Core.Native.IUnknown>(ref val);
