...
public unsafe static class D3DIncludeVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Open<T0>(this ComPtr<ID3DInclude> thisVtbl, D3DIncludeType IncludeType, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] byte* pFileName, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly T0 pParentData, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] void** ppData, uint* pBytes) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Close(this ComPtr<ID3DInclude> thisVtbl, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] void* pData)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int Close<T0>(this ComPtr<ID3DInclude> thisVtbl, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly T0 pData) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Open<T0>(this ComPtr<ID3DInclude> thisVtbl, D3DIncludeType IncludeType, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] byte* pFileName, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ReadOnlySpan<T0> pParentData, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] void** ppData, uint* pBytes) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Open(this ComPtr<ID3DInclude> thisVtbl, D3DIncludeType IncludeType, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ReadOnlySpan<byte> pFileName, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] void* pParentData, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] void** ppData, uint* pBytes)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int Close<T0>(this ComPtr<ID3DInclude> thisVtbl, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ReadOnlySpan<T0> pData) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
