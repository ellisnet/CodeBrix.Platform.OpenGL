...
public unsafe partial struct ID3DShaderCacheApplication : IComVtbl<ID3DShaderCacheApplication>, IComVtbl<CodeBrix.Platform.OpenGL.Core.Native.IUnknown>
{
    ...
    public static implicit operator CodeBrix.Platform.OpenGL.Core.Native.IUnknown(ID3DShaderCacheApplication val)
        => Unsafe.As<ID3DShaderCacheApplication, CodeBrix.Platform.OpenGL.Core.Native.IUnknown>(ref val);
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int GetExePath([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] char** pExePath)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int GetExePath([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char* pExePath)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int GetInstallerName([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] char** pInstallerName)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int GetInstallerName([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char* pInstallerName)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public readonly int GetExePath([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] string[] pExePathSa)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
    ...
    /// <summary>To be documented.</summary>
    public readonly int RegisterComponent<TI0>([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char pName, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char pStateObjectDBPath, uint NumPSDB, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly D3DShaderCachePsdbProperties pPSDBs, out ComPtr<TI0> ppvComponent) where TI0 : unmanaged, IComVtbl<TI0>
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        // ComPtrOverloader
        ppvComponent = default;
    ...
    /// <summary>To be documented.</summary>
    public readonly int GetInstallerName([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] string[] pInstallerNameSa)
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        // StringArrayOverloader
    ...
    /// <summary>To be documented.</summary>
    public readonly ComPtr<TI0> RegisterComponent<TI0>([Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char pName, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly char pStateObjectDBPath, uint NumPSDB, [Flow(CodeBrix.Platform.OpenGL.Core.Native.FlowDirection.In)] ref readonly D3DShaderCachePsdbProperties pPSDBs) where TI0 : unmanaged, IComVtbl<TI0>
    {
        var @this = (ID3DShaderCacheApplication*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        // NonKhrReturnTypeOverloader
